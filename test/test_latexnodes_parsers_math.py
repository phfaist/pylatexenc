...
from pylatexenc.latexnodes.parsers import LatexDelimitedGroupParser
...
#
#         latextext = r'''
# $a=z \begin{nomath} with \(c=1\) \end{nomath}$'''.lstrip()
#
#         nomathenvspec = CallableSpecBase()
#         nomathenvspec.get_ ............... ???????????????????
#             "text",
#             arguments_spec_list=[
#                 textmodeargspec,
...
#         latex_context.specs['environments']['nomath'] = nomathenvspec .........???
#
#         tr = LatexTokenReader(latextext)
